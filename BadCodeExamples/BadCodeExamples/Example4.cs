...
//Может быть SOLID, а именно Барбары Лисков. Стоит метод "fly", который ожидает птицу умеющую летать, но затем ожидание меняется throw new Exception("Kiwi don't fly") смысл этих строчек я не понял.
